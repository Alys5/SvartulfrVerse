...
- [x] Task 1: Leggere e profilare il file `memories.json`
  - [x] Identificare sezioni e chiavi presenti
  - [x] Misurare la lunghezza dei contenuti non vuoti
  - [x] Raccogliere snippet rappresentativi senza importare metadati personali

- [x] Task 2: Classificare i contenuti
  - [x] Separare dati World-layer da Character/Experience/Engine meta
  - [x] Escludere preferenze utente, macro, task recenti, prompt, initial message e chat state
