...
- Use [`../../1_template/SvartulfrVerse_World_Template.lorebook.json`](../../1_template/SvartulfrVerse_World_Template.lorebook.json) for the integrated World MacroCosmo + MicroCosmo lorebook.
- Use [`../../1_template/SvartulfrVerse_World_Template.js`](../../1_template/SvartulfrVerse_World_Template.js) only as a technical runtime reference or migration scaffold.
- Use [`../../1_template/SvartulfrVerse_Scenario_Template.js`](../../1_template/SvartulfrVerse_Scenario_Template.js) only as a technical runtime reference or migration scaffold for scenario behavior.
- Use [`../../1_template/SvartulfrVerse_Engine_Template.js`](../../1_template/SvartulfrVerse_Engine_Template.js) as `level 0` for state persistence, not for lore meaning.
...
1. [`../../1_template/SvartulfrVerse_Engine_Template.js`](../../1_template/SvartulfrVerse_Engine_Template.js) as `level 0` for runtime state and budget-aware context mechanics.
2. [`../../1_template/SvartulfrVerse_World_Template.lorebook.json`](../../1_template/SvartulfrVerse_World_Template.lorebook.json) as `level 1` for integrated World MacroCosmo + MicroCosmo lore, timeline events, NPC data, relationships, secrets, canon unlocks, cascade activation, and adaptive detail.
