...
const LONDON_1666_LORE = [
    ...
    makeEntry("regency_legacy_boundary", "world", "WRD", ["Regency", "Regency legacy", "early 19th century", "Regency visual DNA", "gas lamp", "ballroom", "drawing room politics", "Georgian townhouses", "grand estates", "drawing rooms", "cobblestone streets", "horse-drawn carriages", "footmen", "livery", "silk wallpaper", "crystal chandeliers", "mahogany furniture"], 7, 7.0, "CANDIDATE", "", " [CANDIDATE] WRD Source: 2_Export/World/Pirate/legacy/Visual_DNA.md. Legacy Regency material describes aristocratic elegance, rigid propriety, gas lamps, Georgian townhouses, grand estates, drawing rooms, ballrooms, cobblestone streets, horse-drawn carriages, servants, footmen in livery, silk wallpaper, crystal chandeliers, mahogany furniture, and warm amber/obsidian lighting. In strict London1666, treat it as a later early-19th-century visual/social boundary or explicit crossover residue, not default 1666 canon. If reused, filter it through 1666 merchant-house respectability rather than full Regency ballroom society.", "Regency legacy is candidate/crossover visual and social residue, not default 1666 canon."),
    makeEntry("legacy_visual_dna_regency_filter", "world", "WRD", ["legacy visual DNA", "warm cinematic lighting", "Rembrandt lighting", "deep shadows", "amber obsidian palette", "painterly realism", "luxury visual storytelling", "Regency drawing room", "opulent drawing room"], 6, 6.0, "CANDIDATE", "", " [CANDIDATE] WRD Source: 2_Export/World/Pirate/legacy/Visual_DNA.md. The legacy visual package includes warm cinematic lighting, Rembrandt lighting, deep shadows, amber and obsidian palette, painterly realism, luxury visual storytelling, and an opulent drawing-room image with crystal chandeliers, silk wallpaper, mahogany furniture, gas lamps, footmen, and carriage silhouettes. For London1666, preserve only the dark luxury, candle/oil-lamp chiaroscuro, carved wood, heavy textiles, and merchant-house opulence; do not import Regency ballrooms, gas lamps, or early-19th-century social choreography as default canon.", "Legacy visual DNA: keep dark luxury, filter out Regency-specific social forms."),
    makeEntry("legacy_regency_npcs_boundary", "npc", "NPC", ["Marcus", "Visconte Angelo", "Angel Moreno", "Angel&Co", "Alyssa", "Erik", "legacy NPC", "PMC operative", "billionaire fashion patron", "Vanguard Lieutenant"], 5, 5.0, "CANDIDATE", "", " [CANDIDATE] NPC Source: 2_Export/World/Pirate/legacy/W_Regency.js. Legacy files contain NPC records for Marcus, a human PMC operative and Vanguard Lieutenant/bodyguard, and Visconte Angelo 'Angel' Moreno, a 40-year-old reclusive billionaire, mentor to Alyssa, fashion patron of Angel&Co. These are not London1666 characters. Do not activate them in Pirate/London1666 unless a deliberate modern/regency crossover is requested; treat them only as cross-world boundary examples.", "Legacy NPCs are non-canon to London1666 unless explicitly crossing timelines."),
