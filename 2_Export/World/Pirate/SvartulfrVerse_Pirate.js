...
function applyWorldDebug() {
    ...
    appendIfMissing("scenario", " [WORLD DEBUG] Pirate placeholder loaded. loreEntries: " + loreEntries.length + ", timelineEvents: " + timelineEvents.length + ", statReactions: " + statReactions.length + ".");
}
