...
const WORLD_METADATA = {
    ...
    sourceBase: "world/modern/",
    rootFolder: "2_Export/WorldModern/"
};
...
function applyWorldDebug() {
    ...
    appendIfMissing("scenario", " [WORLD DEBUG] Modern placeholder loaded. loreEntries: " + loreEntries.length + ", timelineEvents: " + timelineEvents.length + ", statReactions: " + statReactions.length + ".");
}
...
// var loreEntries = [
//     {
//         id: "modern_location_0x01",
//         category: "location",
//         prefix: "LOC",
//         keywords: ["Los Angeles", "LA"],
//         priority: 11,
//         importance: 10.0,
//         source: "world/modern/modern_location_0x01.md",
//         canonLayer: "ACTIVE",
//         full: {
//             personality: "",
//             scenario: " [ACTIVE] LOC Source: world/modern/modern_location_0x01.md. Inserire fatti concreti qui."
//         }
//     }
// ];
