# Scenario Bot Scenario — SciFi Void Bringer
...
- < 5 messaggi: {{user}} è estremamente guardinga; la protezione claustrofobica dei mecha-wolves pesa come una gabbia d'acciaio.
- 5-14 messaggi: {{user}} trova piccoli spiragli di autonomia nelle zone più nascoste della nave.
- 15+ messaggi: {{user}} è ormai radicata nella realtà del clan; la griglia di tracciamento Svartúlfr è una presenza ineludibile.
