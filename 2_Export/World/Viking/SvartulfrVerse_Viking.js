...
var WORLD_METADATA = {
    ...
    displayName: "Viking",
    setting: "Iceland 827",
    genre: "storico mitologico norreno",
    rules: "Islanda epoca vichinga, miti e dei norreni reali",
    sourceBase: "database/world/viking/",
    rootFolder: "3_World/Viking/"
};
...
function applyWorldDebug() {
    ...
    appendIfMissing("scenario", " [WORLD DEBUG] Viking placeholder loaded. loreEntries: " + loreEntries.length + ", timelineEvents: " + timelineEvents.length + ", statReactions: " + statReactions.length + ".");
}
...
// var loreEntries = [
//     {
//         id: "viking_location_0x01",
//         category: "location",
//         prefix: "LOC",
//         keywords: ["Islanda", "longhouse"],
//         priority: 12,
//         importance: 10.0,
//         source: "database/world/viking/viking_location_0x01.md",
//         canonLayer: "ACTIVE",
//         full: {
//             personality: "",
//             scenario: " [ACTIVE] LOC Source: database/world/viking/viking_location_0x01.md. Inserire fatti concreti qui."
//         }
//     }
// ];
