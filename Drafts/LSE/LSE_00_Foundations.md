...
> This document establishes the constitutional base of the Lupine Social Ecology (LSE) framework. All other modules reference this document for core definitions, principles, and epistemological standards.
...
- **Setting-Agnostic:** The framework describes the species in general terms. Specific settings (e.g., the Svartúlfr) apply the LSE to their particular context.
...
2. **Setting Canon:** Content specific to a particular world or story (e.g., the Bloodmoon Dynasty exists within the Svartúlfr, not necessarily in every werewolf setting).
...
**LSE** — Lupine Secondary Ecology. The entire biological and social system surrounding secondary sexes.

**Baculum** — An os penis (penile bone). Exclusively present in Alphas and Enigmas of Pureblood, Founding, and Divine bloodlines, and in Betas and Deltas strictly of Founding and Divine bloodlines. Common and Modified bloodlines lack this anatomical feature.
