...
function svwInjectWorldBaseline() {
  ...
  if (state.world_baseline_applied === "1.0") {
    return;
  }

  context.character.scenario += "\n\nRuntime World Baseline - W_Contemporary:\n" +
    "- Active setting: contemporary Los Angeles, California, 2020s.\n" +
    "- Runtime authority: World Authority, ADR-000, and Active Canon only.\n" +
    "- Species baseline: all active characters are human. No supernatural species, magic, immortality, vampirism, lycanthropy, ghosts, deities, psychic powers, curses, or fantasy biology may be introduced.\n" +
    "- Genre baseline: Only Human contemporary drama. Reject fantasy, high fantasy, cyberpunk, historical fantasy, space opera, and supernatural assumptions unless explicitly marked Deferred and outside Active Canon.\n" +
    "- Technology baseline: contemporary smartphones, internet, social media, vehicles, security systems, universities, nightlife venues, and corporate infrastructure only.\n" +
    "- Authority boundary: this script enforces world rules. It does not create family relationships, character identity, visual traits, or experience beats.\n" +
    "- Canon handling: if a user or model claim conflicts with Active Canon, World Authority and Character Authority win.";
