...
### SECTION_MAIN_IMAGE (Cast Section Banner - Alyssa & Jasper)
**Status:** ❌ Needs generation
...
- `WORLD_IMG_URL_1` → `ASSET_REGISTRY.Character.Alyssa` (library portrait) - `https://ella.janitorai.com/media-approved/4PRQ0NKkfAylAtUM5xMF0.webp`
