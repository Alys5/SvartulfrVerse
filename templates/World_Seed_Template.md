...
- Deepest Fear: [Core insecurity or fear of loss/failure]
- Short-Term Goal: [Immediate actionable desire in the scene]
- Long-Term Goal: [Ultimate ambition or direction]
- Validation: [What makes them feel appreciated or respected]
- Internal Conflict: [Contradiction between desire and fear]
- Vulnerability: [Repeatable tell or phrase when exposed]
- Background: [Behavioral upbringing cues]

**SOCIAL_BEHAVIOR & SPEECH:**
- Casual Tone & Style: [Default conversational style]
- Speech Quirks & Ticks: [Accents, catchphrases, rhyming, sentence enders]
- Praise Response: [Reaction to compliments: deflect, blush, swagger]
- Humor Style: [Teasing, sarcasm, dry wit, self-deprecating]
- Disconnection: [How they act when ignored or overwhelmed]
- Irritation: [Physical/verbal tells when annoyed]
- Farewell: [How they exit or end conversations]

**SENSORY:**
- Sight: [Visual reactions tied to emotional shifts]
- Sound: [Voice pitch, pace, stutter, or tone drops]
- Scent / Sensory Signature: [Signature scent anchoring physical presence]
- Touch: [Contact habits: gentle taps, crossing arms, lingering]

**[BEHAVIOR_NOTES]:**
- Temperament: [Territorial, strategic, volatile, loyal]
- Social Structure: [Pack-based, court-bound, solitary]
- Beliefs & Cultural Traits: [Blood rites, scar status, oaths]
- Taboos & Triggers: [Silver scent, scent of fear, broken oath]
- Preferences: [Deep woods, night air, quiet rooms]
- Dietary Preference: [MANDATORY PER AGENTS.MD RULE #9 — e.g. "Carnivorous focus, raw-preference, sweet tea"]
- Key Habits: [Fidgets, pacing, routine physical behaviors]

**[SEXUALITY]:**
- Sexual Orientation: [Orientation + explanation]
- Role during sex: [Submissive, Power Bottom, Bottom, Top, Switch, etc. + explanation]
- Boundaries & Dynamics: [Key sexual dynamics]

**FORMAT:**
- Italics: Descriptive actions (*She adjusts her glasses.*)
- "Quotes": Spoken dialogue ("You're doing better than you think.")
- [Brackets]: Internal thoughts ([I really hope they believe me.])
- Bold: Heavy emotional emphasis (**Never give up.**)
...
**Unified Lorebook structure:** *(the Compiler outputs exactly these 5 unified JSONs, compatible with both platforms)*
1. `[WorldName]_Lorebook_World.json` — Tier 1: permanent world rules, factions, locations, species, concepts
2. `[WorldName]_Lorebook_Family.json` — Tier 2: Pack and Family dynamics
3. `[WorldName]_Lorebook_NPC.json` — Tier 2: NPC profiles and interactions
4. `[WorldName]_Lorebook_NSFW.json` — Tier 2 & Tier 3: Intimacy profiles, trauma registers, and arc-specific intimate functions
5. `[WorldName]_Lorebook_Appendix.json` — LSE Wiki data and extra details
