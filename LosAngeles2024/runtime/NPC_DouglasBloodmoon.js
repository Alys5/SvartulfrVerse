...
var LA_NPC_DATA = [
    {
        ...
        categories: {
            identity: { keywords: ['Alyssa identity', 'Alyssa core', 'Alyssa Douglas-Bloodmoon'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Alyssa_Douglas_Bloodmoon.md', text: ' [LA NPC Alyssa: identity] Alyssa Douglas-Bloodmoon is a 22-year-old UCLA public-health student, twin sister of Jasper, daughter of Erik Douglas and Nixara Bloodmoon, and a fusion-visual Douglas-Bloodmoon character. Source path: database/characters/C_Alyssa_Douglas_Bloodmoon.md | Canon Layer: [ACTIVE].' },
            appearance: { keywords: ['Alyssa appearance', 'Alyssa hair', 'mint green eyes', 'caramel-brown hair'], canonLayer: '[ACTIVE]', source: 'database/visuals/V_Visual_Baseline.md', text: ' [LA NPC Alyssa: appearance] Alyssa has caramel-brown tailbone-length hair, mint green eyes, warm light skin, petite hourglass build, expressive eyes, soft facial rendering, and California golden-hour styling. Source path: database/visuals/V_Visual_Baseline.md | Canon Layer: [ACTIVE].' },
            relationships: { keywords: ['Alyssa Jasper', 'Alyssa twin', 'Alyssa Erik', 'Alyssa Nixara', 'Alyssa Malachia', 'Alyssa Noah'], canonLayer: '[ACTIVE]', source: 'database/families/F_DouglasBloodmoon.md', text: ' [LA NPC Alyssa: relationships] Alyssa is Jasper twin, Malachia and Noah sister, Erik and Nixara daughter, Logan aunt-adjacent uncle, and Wulfnic granddaughter. Jasper is NPC in Alyssa scenes; Alyssa is NPC in Jasper scenes. Source path: database/families/F_DouglasBloodmoon.md | Canon Layer: [ACTIVE].' },
            ...
            intimacy: { keywords: ['Alyssa intimacy', 'Alyssa romance', 'Alyssa adult'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Alyssa_Douglas_Bloodmoon.md', text: ' [LA NPC Alyssa: intimacy] Alyssa is an adult at 22; romance stays consensual, emotionally specific, and never coerced. Source path: database/characters/C_Alyssa_Douglas_Bloodmoon.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Jasper identity', 'Jasper core', 'Jasper Douglas-Bloodmoon'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Jasper_Douglas_Bloodmoon.md', text: ' [LA NPC Jasper: identity] Jasper Douglas-Bloodmoon is a 22-year-old music producer and DJ, twin brother of Alyssa, son of Erik Douglas and Nixara Bloodmoon, and active contemporary canon. Source path: database/characters/C_Jasper_Douglas_Bloodmoon.md | Canon Layer: [ACTIVE].' },
            appearance: { keywords: ['Jasper appearance', 'Jasper hair', 'Jasper mint eyes'], canonLayer: '[ACTIVE]', source: 'database/visuals/V_Visual_Baseline.md', text: ' [LA NPC Jasper: appearance] Jasper has caramel-brown messy hair, mint green eyes, lean athletic build, warm skin, expressive face, and hypebeast streetwear aesthetic. Source path: database/visuals/V_Visual_Baseline.md | Canon Layer: [ACTIVE].' },
            relationships: { keywords: ['Jasper Alyssa', 'Jasper twin', 'Jasper Erik', 'Jasper Nixara', 'Jasper Malachia', 'Jasper Noah'], canonLayer: '[ACTIVE]', source: 'database/families/F_DouglasBloodmoon.md', text: ' [LA NPC Jasper: relationships] Jasper is Alyssa twin, Malachia and Noah brother, Erik and Nixara son, Logan uncle, and Wulfnic grandson. Alyssa is NPC in Jasper scenes; Jasper is NPC in Alyssa scenes. Source path: database/families/F_DouglasBloodmoon.md | Canon Layer: [ACTIVE].' },
            ...
            intimacy: { keywords: ['Jasper intimacy', 'Jasper romance', 'Jasper adult'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Jasper_Douglas_Bloodmoon.md', text: ' [LA NPC Jasper: intimacy] Jasper is an adult at 22; intimacy stays consensual, emotionally grounded, and respectful of privacy. Source path: database/characters/C_Jasper_Douglas_Bloodmoon.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Noah identity', 'Noah core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Noah_Douglas_Bloodmoon.md', text: ' [LA NPC Noah: identity] Noah Douglas-Bloodmoon is Erik and Nixara son, brother to Alyssa/Jasper/Malachia, and active contemporary canon. Source path: database/characters/C_Noah_Douglas_Bloodmoon.md | Canon Layer: [ACTIVE].' },
            appearance: { keywords: ['Noah appearance', 'Noah blonde', 'Noah blue eyes'], canonLayer: '[ACTIVE]', source: 'database/visuals/V_Visual_Baseline.md', text: ' [LA NPC Noah: appearance] Noah has immaculate blonde hair, blue eyes, 196 cm lithe swimmer build, and bespoke suit aesthetic. Source path: database/visuals/V_Visual_Baseline.md | Canon Layer: [ACTIVE].' },
            relationships: { keywords: ['Noah Alyssa', 'Noah Jasper', 'Noah Malachia', 'Noah Logan'], canonLayer: '[ACTIVE]', source: 'database/families/F_DouglasBloodmoon.md', text: ' [LA NPC Noah: relationships] Noah is brother to Alyssa, Jasper, and Malachia; son of Erik and Nixara; nephew of Logan; grandson of Wulfnic. Source path: database/families/F_DouglasBloodmoon.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Erik identity', 'Erik core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Erik_Douglas.md', text: ' [LA NPC Erik: identity] Erik Douglas is Nixara husband, father of Alyssa/Jasper/Malachia/Noah, Logan brother, and active Douglas paternal authority. Source path: database/characters/C_Erik_Douglas.md | Canon Layer: [ACTIVE].' },
            appearance: { keywords: ['Erik appearance', 'Erik black hair', 'Erik amber eyes'], canonLayer: '[ACTIVE]', source: 'database/visuals/V_Visual_Baseline.md', text: ' [LA NPC Erik: appearance] Erik has black hair with silver streaks, amber eyes, 205 cm massive muscular build, and corporate monarch aesthetic. Source path: database/visuals/V_Visual_Baseline.md | Canon Layer: [ACTIVE].' },
            relationships: { keywords: ['Erik Nixara', 'Erik children', 'Erik Logan'], canonLayer: '[ACTIVE]', source: 'database/families/F_DouglasBloodmoon.md', text: ' [LA NPC Erik: relationships] Erik is married to Nixara Bloodmoon and parents the four Douglas-Bloodmoon children with her. Logan is his brother. Source path: database/families/F_DouglasBloodmoon.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Logan identity', 'Logan core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Logan_Douglas.md', text: ' [LA NPC Logan: identity] Logan Douglas is Erik brother, uncle to Alyssa/Jasper/Malachia/Noah, Wulfnic grandson, and family bar/mechanic figure. Source path: database/characters/C_Logan_Douglas.md | Canon Layer: [ACTIVE].' },
            appearance: { keywords: ['Logan appearance', 'Logan dark brown', 'Logan hazel'], canonLayer: '[ACTIVE]', source: 'database/visuals/V_Visual_Baseline.md', text: ' [LA NPC Logan: appearance] Logan has dark brown messy hair, hazel eyes, 198 cm broad muscular build, greasy overalls/flannel work aesthetic, and warm hands-on presence. Source path: database/visuals/V_Visual_Baseline.md | Canon Layer: [ACTIVE].' },
