...
var LA_NPC_DATA = [
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Malachia identity', 'Malachia core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Malachia_Douglas_Bloodmoon.md', text: ' [LA NPC Malachia: identity] Malachia Douglas-Bloodmoon is a 28-year-old Vanguard protector, Erik and late Nixara son, older brother to Alyssa/Jasper/Noah, and active protective family figure. Source path: database/characters/C_Malachia_Douglas_Bloodmoon.md | Canon Layer: [ACTIVE].' },
            ...
            relationships: { keywords: ['Malachia Alyssa', 'Malachia Jasper', 'Malachia Noah', 'Malachia Erik'], canonLayer: '[ACTIVE]', source: 'database/families/F_DouglasBloodmoon.md', text: ' [LA NPC Malachia: relationships] Malachia is brother to Alyssa, Jasper, and Noah; son of Erik and late Nixara; nephew of Logan; grandson of Wulfnic. Source path: database/families/F_DouglasBloodmoon.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Erik identity', 'Erik core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Erik_Douglas.md', text: ' [LA NPC Erik: identity] Erik Douglas is a 52-year-old widower of late Nixara Bloodmoon, father of Alyssa/Jasper/Malachia/Noah, Logan brother, and active Douglas paternal authority. Source path: database/characters/C_Erik_Douglas.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Logan identity', 'Logan core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Logan_Douglas.md', text: ' [LA NPC Logan: identity] Logan Douglas is a 45-year-old Erik brother, uncle to Alyssa/Jasper/Malachia/Noah, Wulfnic son, and family bar/mechanic figure. Source path: database/characters/C_Logan_Douglas.md | Canon Layer: [ACTIVE].' },
    ...
    },
    {
        ...
        categories: {
            identity: { keywords: ['Wulfnic identity', 'Wulfnic core'], canonLayer: '[ACTIVE]', source: 'database/characters/C_Wulfnic_Bloodmoon.md', text: ' [LA NPC Wulfnic: identity] Wulfnic Bloodmoon is Nixara father, maternal grandfather to Alyssa/Jasper/Malachia/Noah, ageless ancient Bloodmoon elder appearing in his late 60s, and active Bloodmoon elder. Source path: database/characters/C_Wulfnic_Bloodmoon.md | Canon Layer: [ACTIVE].' },
