...
| Field | Value |
|-------|-------|
| Mission | Absolute protection of Douglas family and DCC assets |
...
| Field | Value |
|-------|-------|
| Hierarchy | Division under DCC corporate structure |
...
| Element | Details |
|---------|---------|
| Code Name Origin | "Black Wolf" was Kaladin Narghaton's operational codename during Special Forces service |
...
### Vanguard PMC Transition

| Previous | Current |
|----------|---------|
| Vanguard PMC | DCC Security — Black Wolf Division |
| Independent PMC | Division under DCC corporate structure |
| Deferred Canon | Active Canon |

**Authority Decision:** Vanguard PMC is superseded by DCC Security Black Wolf Division. All references to Vanguard PMC should be updated to reflect the new structure.

### Relationship to Cultural Canon

The "Black Wolf" name creates a narrative connection to the Svartúlfr Cultural Canon (Clan Svartúlfr = Black Wolves). This is:

- **IS:** A narrative easter egg
- **IS:** A coincidence Erik found "interesting"
- **IS NOT:** A supernatural connection
