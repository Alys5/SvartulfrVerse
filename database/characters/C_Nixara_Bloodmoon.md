# Nixara Bloodmoon — Database Record

**Status:** ACTIVE CANON  
**Date:** 2026-06-08  
**Authority:** Character Authority + Family Authority  
**Canon Layer:** Active Canon (Layer 1 — ADR-006)  
**Record Type:** Primary Canon Character — Deceased (2005)  
...
| Field | Value | Status |
|-------|-------|--------|
| Full Name | Nixara Bloodmoon | Canonical |
| Dynasty | Bloodmoon (by birth) / Douglas-Bloodmoon (by union) | Canonical |
| Born | 1975 | Canonical |
| Died | 2005 (during childbirth — twins Jasper and Alyssa) | Canonical |
| Nationality | American (Icelandic descent) | Canonical |
| Species | Human | ADR-000 Compliant |
| Gender | Female | Canonical |

---

## Visual Authority

**Classification:** Primary Maternal Morphological Template (ADR-004)

Nixara Bloodmoon serves as the primary morphological template for the Douglas-Bloodmoon first generation. She carries pure Bloodmoon visual DNA.

| Attribute | Value | Classification |
|-----------|-------|----------------|
| Height | 165 cm | Canonical |
| Body | Petite hourglass | Canonical |
| Measurements | 95-55-95 | Canonical |
| Face | Soft facial structure, delicate jawline, fair skin | Canonical |
| Eyes | Ice Blue | Bloodmoon chromatic |
| Hair | Blonde, tailbone-length, silky straight | Bloodmoon chromatic |

### Visual Inheritance Significance

- **Alyssa Douglas-Bloodmoon:** Strongest morphological inheritance from Nixara (silhouette, proportions, facial structure). "Alyssa physically resembles Nixara more than any other descendant" (ADR-004).
- **Jasper Douglas-Bloodmoon:** Morphological inheritance from Nixara + fusion-blend coloration (Caramel-brown hair, Mint green eyes).
- **Noah Douglas-Bloodmoon:** Chromatic inheritance from Nixara (Blonde hair, Blue eyes = Bloodmoon dominant).
- **Malachia Douglas-Bloodmoon:** Douglas-dominant visual (Black hair, Amber eyes). Minimal Nixara visual expression.
...
| Role | Details |
|------|---------|
| Dynasty Member | Bloodmoon (by birth) |
| Position | Daughter of Wulfnic Bloodmoon |
| Generation | Third documented generation of Bloodmoon line in America |
| Significance | Bridge between Bloodmoon and Douglas dynasties |

### Douglas-Bloodmoon Union

| Role | Details |
|------|---------|
| Union Position | Co-founder of Douglas-Bloodmoon Dynasty |
| Union Partner | Erik Douglas |
| Union Type | Dynastic Union (merges Bloodmoon + Douglas lines) |
| Marriage Record | MR-001 |
| Status | Ended by death (2005) |

### Key Relationships

| Relation | Person | Type | Status |
|----------|--------|------|--------|
| Father | Wulfnic Bloodmoon | Biological | PC-001 |
| Husband | Erik Douglas | Dynastic Union | MR-001 |
| Son | Malachia Douglas-Bloodmoon | Biological | PC-002 / PC-006 |
...
Nixara is the daughter of Wulfnic Bloodmoon (PC-001). She was raised by Wulfnic with deep connection to both her Icelandic Bloodmoon heritage and her American identity. Her marriage to Erik Douglas in the 1990s created the Douglas-Bloodmoon dynastic union — the foundational merge of the two family lines.

### Relationship to Erik Douglas

Nixara is the wife of Erik Douglas (MR-001). Their union is the foundational dynastic merge for the Los Angeles Dynasty. The union creates a new dynasty branch (Douglas-Bloodmoon) while preserving the distinct root dynasties.

### Relationship to Children

Nixara is the biological mother of all four Douglas-Bloodmoon heirs:
- **Malachia** (born 1996) — Eldest son, firstborn
- **Noah** (born 1999) — Middle son, second-born
- **Jasper** (born 2005) — Youngest son, twin of Alyssa
- **Alyssa** (born 2005) — Daughter, twin of Jasper

Nixara died during childbirth in 2005, delivering the twins Jasper and Alyssa.
...
**Primary Role:** Bridge between dynasties. Nixara connects the Bloodmoon line (Icelandic heritage) to the Douglas line (English mercantile tradition) through her union with Erik Douglas.

**Significance:**
- Without Nixara, there is no Douglas-Bloodmoon dynasty.
- She is the maternal template for the first generation's visual identity.
- Her death in 2005 (childbirth) is a foundational family trauma that shapes:
  - Wulfnic's intensified protection of the grandchildren
  - Erik's grief and single parenthood
  - Malachia's vow to protect the family
  - Jasper and Alyssa's maternal absence
...
|--------|--------|--------------|
| Family | `database/families/F_Parent_Child.md` | PC-001, PC-006, PC-007, PC-008, PC-009 |
...
**Character ID:** C_Nixara  
**Canon Layer:** Active Canon (Layer 1)  
**Classification:** Primary Canon Character — Deceased  
**Record Custodian:** Character Authority + Family Authority  
**Migration Date:** 2026-06-08  
**Created:** 2026-06-08 (Missing Character Closure — Phase 1)  
**Depends on:** ADR-000, ADR-001, ADR-002, ADR-004  
**Evidence:** 61 references across 19 database files; ADR-004 Visual Definition (lines 206-235); Roadmap Execution Charter approved family tree
