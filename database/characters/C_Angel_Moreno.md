...
| Field | Value |
|-------|-------|
| Source | database/canon_candidates/Candidate_Angel_Moreno.md + Canonization Decision |
...
| Field | Value | Status |
|---------|-------|--------|
| ID | C_Angel_Moreno | Canonical |
| Full Name | Angel Moreno | Canonical |
| Alias | Angel | Canonical |
| Canon Classification | Secondary Canon Character | Canonical |
| Age | 32 | Canonical |
| Gender | Male | Canonical |
| Species | Human | ADR-000 Compliant |
| Location | Los Angeles, California | Canonical |
...
| Trait | Description |
|-------|-------------|
| Sophisticated | Refined tastes, cultured demeanor |
| Elegant | Graceful in manner and presentation |
| Eccentric | Unconventional, artistically unpredictable |
| Artistically driven | Passionate about creative expression |
| Socially intelligent | Reads people and situations with precision |
| Politically cautious | Navigates power dynamics with care |
| Protective | Guards those he mentors without controlling |

---

## Character Core

These traits are stable across all documented incarnations:

| Trait | Function |
|-------|----------|
| Patron | Financial supporter of Alyssa's modeling career |
| Mentor | Guides Alyssa's professional development |
| Talent Scout | Recognizes and cultivates exceptional potential |
| Aesthetic Obsession | Drawn to beauty, fragility, and artistic expression |
| Artistic Vision | Sees creative possibilities others miss |
| Alternative Path to Independence | Represents opportunity outside family structure |

---

## Narrative Function

**Primary Role:** Alyssa Douglas-Bloodmoon's patron, mentor, and first external opportunity.

**World Function:** Independent authority figure operating outside the Douglas family hierarchy.

**Key Relationships:**

| Character | Relationship | Nature |
|-----------|-------------|--------|
| Alyssa Douglas-Bloodmoon | Patron / Mentor | Professional mentorship evolving into genuine sponsorship |
| Douglas Family | Independent operator | NOT part of Douglas hierarchy; maintains professional distance |
...
> **Classification: Historical Variants — NOT Contemporary Canon**

The following incarnations exist ONLY in legacy cross-world archives and are explicitly excluded from the contemporary baseline:

| Variant | World Setting | Excluded Attributes |
|---------|--------------|-------------------|
| Vampire Lord of Solarton | Urban Fantasy, High Fantasy, Cyber | Immortality, vampire nature, supernatural powers |
| Archon / Sylthari | Fantasy worlds | Supernatural entity classification |
| Immortal Noble | Multiple fantasy settings | Immortality, ancient age (832 years) |
| Visconti Title | Regency, Cyber, Fantasy | Aristocratic title (historical variant only) |

**All supernatural attributes are REJECTED per ADR-000 (Human only, non-supernatural).**

These variants are preserved as historical evidence in the Progetti archive and in the Candidate_Angel_Moreno.md recovery document.
